              ...
              {user ? (
                <div className="flex items-center gap-4">
                  ...
                  <DropdownMenu>
                    <DropdownMenuTrigger asChild>
                      <Button
                        variant="ghost"
                        className="flex items-center gap-2 pl-2 h-9 hover:bg-muted/50 transition-all rounded-full border border-muted-foreground/10"
                      >
                    ...
                    <DropdownMenuContent
                      align="end"
                      className="w-56 glass mt-1 border-primary/10"
                    >
                      ...
                      {mounted &&
                        user.role === "PROFESSOR" &&
                        (user.isProfessorVerified || user.isVerified) && (
                ...
                <div className="flex items-center gap-3">
                  ...
                  <Button
                    ...
                    variant="gradient"
                    size="sm"
                    className="text-xs font-bold px-5 shadow-lg shadow-primary/20 transition-all hover:scale-105 active:scale-95"
                  >
              ...
              <div className="flex flex-col gap-2">
                {navLinks.map((link) => (
                  <Link
                    ...
                    className={`flex items-center gap-4 text-lg font-bold p-4 rounded-xl transition-all ${
                      (pathname || "") === link.href
                  ...
                  >
                    <link.icon
                      className={`h-5 w-5 ${(pathname || "") === link.href ? "text-primary" : "text-muted-foreground"}`}
                    />
                    {link.label}
                  </Link>
                ))}
                ...
                {isAuthLoading ? (
                  ...
                  <div className="grid grid-cols-2 gap-4 h-12">
                    <Button
                      asChild
                      variant="outline"
                      className="w-full h-full font-bold rounded-xl"
                    >
